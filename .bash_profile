...
alias s2='/opt/SublimeText2/sublime_text'
alias em='emacs'
...
alias gp='git push'
alias up='appcfg.py update --oauth2'
alias down='appcfg.py rollback --oauth2'
...
# Git Completion Bash
if [ -f ~/src/git-completion.bash ]; then
    source ~/src/git-completion.bash
fi

# Google Appengine
export PATH=$PATH:~/bin/google_appengine
export PATH=$PATH:~/bin/appengine-java-sdk/bin
...
# PYTHONPATH
export PYTHONPATH=$PYTHONPATH:~/bin/google_appengine
